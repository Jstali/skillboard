...
import HRMSOrganizationView from './components/HRMSOrganizationView';
    ...
    <BrowserRouter>
      <div className="min-h-screen pb-16 px-4">
        <Routes>
          ...
          <Route path="/test/hrms-organization" element={<PrivateRoute><HRMSOrganizationView /></PrivateRoute>} />
...
const RoleBasedRedirect: React.FC = () => {
  ...
  // Check is_admin flag first for backwards compatibility
